...
#Load DataFrame
df = pd.read_csv(r'.\data\cleaned_data.csv') ##Only for the testing
...
def comprehensive_analysis(df):
    ...
    for idx, row in tqdm(df.iterrows(), total=len(df), desc="Processing"):
        ...
        try:
            ...
            fear_sadness_ratio = (emotions['fear'] / emotions['sadness'] 
                                 if emotions['sadness'] > 0.01 else 0)
            ...
            article_data = {
                ...
                **emotions,
                ...
                'negative_emotion_sum': emotions['fear'] + emotions['sadness'] + emotions['anger']
            }
